...
make -f makefile.linux-mingw $MAKEOPTS DEPSDIR=$STAGING Termocoin.exe USE_UPNP=0 DEBUGFLAGS="-frandom-seed=Termocoin" USE_SSE2=1
$HOST-strip *.exe
rm -rf $OUTDIR/daemon
mkdir $OUTDIR/daemon
