...
uint256 const hashGenesisBlock("0xc4f1bef471bd3b68b16f82ad8614171f7b63216c3a43d63024dc82010a6c0f3f");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Termocoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Termocoin Signed Message:\n";
...
{
    // Termocoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Termocoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Termocoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Irish Times 14/Sept/2014 China and Japan seek closer trade links";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1410692014;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 3048797;
        ...
        assert(block.hashMerkleRoot == uint256("0xbdddcac8cf1ea825f967f96ad7792b53bb2bafb78c0ba5daa100b0de6b77d787"));
          block.print();
...
unsigned char pchMessageStart[4] = { 0xf9, 0xe8, 0xb4, 0xd9 }; // Termocoin: increase each by adding 2 to bitcoin's value.
